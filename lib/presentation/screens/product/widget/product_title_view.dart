...
//
//             Row(children: [
//               Text('${details.reviewList != null ? details.reviewList.length : 0} ${getTranslated("count_reviews", context)} | ',
//                   style: titilliumRegular.copyWith(color: Theme.of(context).hintColor,
//                     fontSize: Dimensions.FONT_SIZE_DEFAULT,)),
//
//               Text('${details.orderCount}  ${getTranslated("count_orders", context)} | ', style: titilliumRegular.copyWith(
//                 color: Theme.of(context).hintColor,
//                 fontSize: Dimensions.FONT_SIZE_DEFAULT,
//               )),
//
//               Text('${details.wishCount}  ${getTranslated("count_wish", context)}', style: titilliumRegular.copyWith(
//                 color: Theme.of(context).hintColor,
//                 fontSize: Dimensions.FONT_SIZE_DEFAULT,
//               )),
//
