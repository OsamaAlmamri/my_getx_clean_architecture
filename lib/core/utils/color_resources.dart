...
class ColorResources {
  ...
  static Color getColombiaBlue(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF678cb5) : Color(0xFF92C6FF);
  }
  static Color getLightSkyBlue(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFc7c7c7) : Color(0xFF8DBFF6);
  }
  static Color getHarlequin(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF257800) : Color(0xFF3FCC01);
  }
  static Color getCheris(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF941546) : Color(0xFFE2206B);
  }
  static Color getTextTitle(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFFFFFFF) : Color(0xFF000743);
  }

  static Color getGrey(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF808080) : Color(0xFFF1F1F1);
  }
  static Color getRed(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF7a1c1c) : Color(0xFFFF5555);
  }
  static Color getYellow(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF916129) : Color(0xFFFFAA47);
  }
  static Color getHint(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFc7c7c7) : Color(0xFF9E9E9E);
  }
  static Color getGainsBoro(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF999999) : Color(0xFFE6E6E6);
  }
  static Color getTextBg(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF414345) : Color(0xFFF8FBFD);
  }
  ...
  static Color getHomeBg(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF3d3d3d) : Color(0xFFFCFCFC);
  }
  static Color getImageBg(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF3f4347) : Color(0xFFE2F0FF);
  }
  static Color getSellerTxt(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF517091) : Color(0xFF92C6FF);
  }
  static Color getChatIcon(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFebebeb) : Color(0xFFD4D4D4);
  }
  static Color getLowGreen(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF7d8085) : Color(0xFFEFF6FE);
  }
  static Color getGreen(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF167d3c) : Color(0xFF23CB60);
  }
  static Color getFloatingBtn(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF49698c) : Color(0xFF7DB6F5);
  }
  static Color getPrimary(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFf0f0f0) : Theme.of(context).primaryColor;
  }
  static Color getSearchBg(BuildContext context) {
    return Get.isDarkMode ? Color(0xFF585a5c) : Color(0xFFF4F7FC);
  }
  static Color getArrowButtonColor(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFBE8551) : Color(0xFFFE8551);
  }
  static Color getReviewRattingColor(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFF4F7FC) : Color(0xFF66717C);
  }
  static Color visitShop(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFF4F7FC) : Color(0xFFF3F5F9);
  }

  static Color couponColor(BuildContext context) {
    return Get.isDarkMode ? Color(0xFFC8E4FF) : Color(0xFFC8E4FF);
  }
